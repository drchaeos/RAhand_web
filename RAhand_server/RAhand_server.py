...
app.mount("/static", StaticFiles(directory="../RAhand/static"), name="static")
app.mount("/images", StaticFiles(directory="../RAhand/images"), name="images")
...
async def serve_index():
    # 현재 스크립트의 위치를 기준으로 상대 경로를 사용합니다.
    current_directory = os.path.join(os.path.dirname(__file__), '..', 'RAhand')
